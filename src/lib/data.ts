...
export const MOCK_UPLOAD_FILES = [
  { id: 'gl-entries', title: 'GL Entries', description: 'Main transaction ledger (CSV/XLSX).', required: true },
  { id: 'budget-holder-map', title: 'Budget Holder Mapping', description: 'Map cost centers to owners.', required: true },
  { id: 'cost-item-map', title: 'Cost Item Map', description: 'Categorize cost items.', required: true },
  { id: 'regional-map', title: 'Regional Mapping', description: 'Assign regions to entries.', required: true },
  { id: 'corrections', title: 'Corrections', description: 'Manual adjustments file.', required: false },
  { id: 'revenue-report', title: 'Revenue Report', description: 'Optional detailed revenue data.', required: false },
];
